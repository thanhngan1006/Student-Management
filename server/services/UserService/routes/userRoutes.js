...
router.post(
  ...
  userController.importUsersFromFile
); //admin import user
...
router.post(
  ...
  authenticateToken,
  authorizeRoles("admin"),
  userController.importAdvisors
); //admin import giáo viên
router.get("/tdt/:tdt_id", userController.getUserByTdtId);
router.delete(
  "/:id",
  authenticateToken,
  authorizeRoles("admin"),
  userController.deleteAdvisor
);
router.post(
  "/add-student",
  authenticateToken,
  authorizeRoles("admin"),
  userController.addStudentByAdmin
);
router.post(
  "/add-advisor",
  authenticateToken,
  authorizeRoles("admin"),
  userController.addAdvisorByAdmin
);
...
router.delete(
  ...
  authenticateToken,
  authorizeRoles("admin"),
  userController.fullDeleteStudent
);
router.put("/:id/add-homeroom-teacher", userController.addHomeroomTeacher);
router.put(
  "/:id/remove-homeroom-teacher",
  userController.removeHomeroomTeacher
);
